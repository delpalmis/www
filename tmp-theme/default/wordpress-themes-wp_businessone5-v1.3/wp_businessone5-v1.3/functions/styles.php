...
if( !function_exists('ci_print_ie6_styles') ):
add_action('wp_head','ci_print_ie6_styles');
function ci_print_ie6_styles() 
{
	?>
	<!--[if IE 7]><link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/ie7.css" media="screen" /><![endif]-->
	<?php
}
endif;
