...
?>
		...
		<ul class="ci-news-extra">
			<?php  while ($r->have_posts()) : $r->the_post(); ?>
				<li>
					<a class="ci-news-title" href="<?php the_permalink() ?>" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>"><?php if ( get_the_title() ) the_title(); else the_ID(); ?></a>
					<span class="ci-news-time"><?php echo get_the_date(); ?></span>
				</li>
			<?php endwhile; ?>
		</ul>
...
function CI_Recent_News_Widget_Register() {
  register_widget('CI_Widget_Recent_News');
}
add_action('widgets_init', 'CI_Recent_News_Widget_Register');
