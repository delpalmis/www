...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'businessone');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'BusinessOne'); 
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=27&t=69');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=27');
