...
function ci_enqueue_fancybox()
{
	...
	{
		wp_enqueue_script('fancybox', get_template_directory_uri().'/panel/scripts/fancybox/source/jquery.fancybox.pack.js', array('jquery'), false, true);
		wp_enqueue_style('fancybox', get_template_directory_uri().'/panel/scripts/fancybox/source/jquery.fancybox.css');
	}
}
endif;
